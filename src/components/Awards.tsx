...
const awards: Award[] = [
  {
    ...
    image: '/images/baby-fox-card-138a29.png',
    status: 'claimed',
    category: 'all',
  ...
  },
  {
    ...
    name: 'Player Fox',
    description: 'Your very first ticket — welcome to the bamboo forest!',
    image: '/images/player-fox-card.png',
    status: 'unclaimed',
    category: 'all',
  ...
  },
  {
    ...
    name: 'Snack Fox',
    description: 'Your very first ticket — welcome to the bamboo forest!',
    image: '/images/snack-fox-card-164b66.png',
    status: 'unclaimed',
    category: 'all',
  ...
  },
  {
    ...
    name: 'Streak Fox',
    description: 'Your very first ticket — welcome to the bamboo forest!',
    image: '/images/streak-fox-card-382987.png',
    status: 'unclaimed',
    category: 'all',
              ...
              <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 lg:bottom-[68px] left-1/2 transform -translate-x-1/2">
                <div className="bg-[#192025] rounded-xl p-1 flex gap-1 shadow-2xl">
                  <button
                    ...
                    className={`px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 lg:px-6 lg:py-3 rounded-lg text-xs sm:text-sm lg:text-base font-bold transition-all duration-200 whitespace-nowrap ${
                      activeTab === 'all'
                ...
                >
                  ...
                  <div className="relative z-10 p-3 sm:p-4 lg:p-6 h-full">
                    ...
                    <div className="absolute top-2 right-2">
                      <span className={`px-2 py-1 sm:px-3 sm:py-1 rounded-md text-xs sm:text-sm font-bold ${
