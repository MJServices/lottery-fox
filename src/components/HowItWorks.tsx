                ...
                <div className="mb-8">
                  <div className="flex gap-2 sm:gap-4 overflow-x-auto pb-2">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition-all ${activeTab === 'privacy-policy'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition-all ${activeTab === 'terms-conditions'
                          ? 'bg-[#8FD811] text-[#253703]'
                          : 'bg-[#2A2F36] text-[#A2B4C6] hover:bg-[#3A3F46] hover:text-white'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition-all ${activeTab === 'bug-bounty'
                          ? 'bg-[#8FD811] text-[#253703]'
                          : 'bg-[#2A2F36] text-[#A2B4C6] hover:bg-[#3A3F46] hover:text-white'
                        }`}
                    >
