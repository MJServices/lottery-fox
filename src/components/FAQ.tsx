                  ...
                  {filteredFAQs().map((faq) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`flex-shrink-0 w-8 h-8 bg-[#FF6B35] rounded-lg flex items-center justify-center transition-transform ${
