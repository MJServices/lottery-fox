                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 py-4 border-b border-[#242D36]">
                      <div className="flex-1">
                        ...
                        <p className="text-[#A2B4C6] text-sm mb-3">
                          Hello, I participated in the lottery draw tha...
                        </p>
                        <div className="flex items-center gap-4 text-xs font-medium text-[#525D68] mb-3">
                          <span>ID: 443905</span>
                      ...
                      <div className="flex flex-col items-end gap-3">
                        <div className="flex items-center gap-3">
                          <div className="px-3 py-1.5 bg-gradient-to-r from-[#1F1813] to-[#E36826] text-white rounded-lg text-xs font-bold flex items-center gap-2 shadow-[0_0_10px_rgba(227,104,38,0.3)] border border-[#E36826]/30">
                          ...
                          <div className="px-2 py-1 bg-[#8FD811] text-[#13181D] rounded text-xs font-bold uppercase">
                            Active
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <button className="px-4 py-1.5 bg-[#2A3441] text-[#A2B4C6] rounded-md font-medium text-xs hover:text-white hover:bg-[#3A4651] transition-all">
                            Close as solved
                          </button>
                          <button
                            onClick={handleViewDetails}
                            className="px-4 py-1.5 bg-[#FF6B35] text-white rounded-md font-medium text-xs hover:opacity-90 transition-opacity"
                          >
                            View details
                          </button>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 py-4 border-b border-[#242D36]">
                      ...
                      <div className="flex flex-col items-end gap-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="px-2 py-1 bg-[#3A4651] text-[#A2B4C6] rounded text-xs font-bold uppercase">
                            Expired
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <button
                            onClick={handleViewDetails}
                            className="px-4 py-1.5 bg-[#2A3441] text-[#A2B4C6] rounded-md font-medium text-xs hover:text-white hover:bg-[#3A4651] transition-all"
                          >
                            View details
                          </button>
                        </div>
