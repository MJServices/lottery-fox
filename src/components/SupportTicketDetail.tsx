        ...
        <div className="flex-1 flex flex-col xl:flex-row min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 lg:p-8 pb-28 lg:pb-8">
            <div className="max-w-7xl mx-auto w-full">
              ...
              {/* Ticket Title */}
              <h1 className="text-white font-bold text-xl mb-6">Lottery prize not credited after draw</h1>

              {/* Ticket Details Grid */}
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                {/* Left Column - Ticket Info */}
                <div className="lg:col-span-1">
                  <div className="bg-[#1A2027] rounded-xl p-4 border border-[#242D36]">
                    <h3 className="text-white font-bold text-sm mb-4">Ticket #1</h3>
                    
                    <div className="space-y-3">
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Status</div>
                        <div className="px-2 py-1 bg-[#8FD811] text-[#253703] rounded text-xs font-bold inline-block">
                          Active
                        </div>
                      </div>
                      
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Priority</div>
                        <div className="px-2 py-1 bg-[#FF6B35] text-white rounded text-xs font-bold inline-block">
                          HIGH
                        </div>
                      </div>
                      
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Category</div>
                        <div className="text-white text-sm">Wallet Connection</div>
                      </div>
                      
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Updated</div>
                        <div className="text-white text-sm">Dec 22, 2025 5:43:06 PM</div>
                      </div>
                      
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Created</div>
                        <div className="text-white text-sm">Dec 22, 2025 5:43:06 PM</div>
                      </div>
                      
                      <div>
                        <div className="text-[#A2B4C6] text-xs font-medium mb-1">Assignee</div>
                        <div className="text-white text-sm">4563456</div>
                      </div>
                    </div>

                    <div className="flex gap-2 mt-4">
                      <button className="flex-1 px-3 py-2 bg-[#2A3441] border border-[#3A4651] text-[#A2B4C6] rounded-lg text-xs font-medium hover:text-white hover:bg-[#3A4651] transition-all">
                        Browse FAQ
                      </button>
                      <button className="flex-1 px-3 py-2 bg-[#FF6B35] text-white rounded-lg text-xs font-medium hover:opacity-90 transition-opacity">
                        Close ticket
                      </button>
                    </div>
                  </div>
